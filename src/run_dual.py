...
if args.model == 'ast':
    ...
    if args.bal == 'bal':
        ...
        train_loader = torch.utils.data.DataLoader(
            dataloader_relay.AudiosetDataset(args.data_train, label_csv=args.label_csv, audio_conf=audio_conf),
    ...
    val_loader = torch.utils.data.DataLoader(
        dataloader_relay.AudiosetDataset(args.data_val, label_csv=args.label_csv, audio_conf=val_audio_conf),
        batch_size=args.batch_size*2, shuffle=False, num_workers=args.num_workers, pin_memory=True)

    audio_model = models.ASTModelDual(label_dim=args.n_class, fstride=args.fstride, tstride=args.tstride, input_fdim=128,
...
if args.dataset == 'speechcommands':
    ...
    eval_loader = torch.utils.data.DataLoader(
        dataloader_relay.AudiosetDataset(args.data_eval, label_csv=args.label_csv, audio_conf=val_audio_conf),
        batch_size=args.batch_size*2, shuffle=False, num_workers=args.num_workers, pin_memory=True)
